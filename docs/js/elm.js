...
var author$project$Main$Product = F3(
	function (id, quantity, name) {
		return {L: id, ad: name, u: quantity};
	});
	...
	function (msg, products) {
		if (!msg.$) {
			if (!msg.a.$) {
				...
				return _Utils_Tuple2(products, elm$core$Platform$Cmd$none);
			}
		} else {
			var productId = msg.a;
			...
			var newProducts = A2(
				elm$core$List$map,
				function (product) {
					return _Utils_eq(product.L, productId) ? _Utils_update(
						product,
						{
							u: A2(
...
var author$project$Main$view = function (products) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_Nil),
									elm$html$Html$text(
									' ' + (product.ad + ((!product.u) ? ' - OUT OF STOCK ' : ' '))),
									A2(
