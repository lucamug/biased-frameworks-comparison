...
var author$project$Main$faIcon = function (icon) {
...
var author$project$Main$viewSocialIcons = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			mdgriffith$elm_ui$Element$spacing(25),
			mdgriffith$elm_ui$Element$centerX,
			A2(mdgriffith$elm_ui$Element$paddingXY, 0, 35)
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_Nil,
			{
				label: author$project$Main$faIcon('fab fa-medium-m'),
				url: 'https://medium.com/@jzxhuang'
			}),
			A2(
			mdgriffith$elm_ui$Element$newTabLink,
			_List_Nil,
			{
				label: author$project$Main$faIcon('fab fa-instagram'),
				url: 'https://instagram.com/jzxhuang/'
			}),
			A2(
			mdgriffith$elm_ui$Element$newTabLink,
			_List_Nil,
			{
				label: author$project$Main$faIcon('fab fa-github'),
				url: 'https://github.com/jzxhuang'
			}),
			A2(
			mdgriffith$elm_ui$Element$newTabLink,
			_List_Nil,
			{
				label: author$project$Main$faIcon('far fa-envelope'),
				url: 'mailto:jzxhuang@edu.uwaterloo.ca'
			}),
			A2(
			mdgriffith$elm_ui$Element$newTabLink,
			_List_Nil,
			{
				label: author$project$Main$faIcon('fab fa-linkedin-in'),
				url: 'https://linkedin.com/in/jzxhuang'
			})
		]));
...
var author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			A3(mdgriffith$elm_ui$Element$rgb255, 248, 249, 250))
		]),
	A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						{description: 'Jeffrey Huang', src: 'https://cdn.dribbble.com/users/1242303/screenshots/3764594/day35.png'}),
						A2(
						mdgriffith$elm_ui$Element$column,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								mdgriffith$elm_ui$Element$text('Jeffrey Huang')),
								A2(
								mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										...
										A3(mdgriffith$elm_ui$Element$rgb255, 170, 170, 170))
									]),
								mdgriffith$elm_ui$Element$text('Ideas start here...')),
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												mdgriffith$elm_ui$Element$text('Hey! I\'m a computer engineering student at the University of Waterloo. I love all things tech, and I also love travelling, snowboarding and trying new food.')
											]))
									]))
							])),
						author$project$Main$viewSocialIcons,
						A2(
						mdgriffith$elm_ui$Element$row,
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Font$light,
								mdgriffith$elm_ui$Element$Font$color(
								A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 139)),
								mdgriffith$elm_ui$Element$centerX,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												mdgriffith$elm_ui$Element$Font$color(
												A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 205))
											]))
									]),
								{
									label: mdgriffith$elm_ui$Element$text('Blog'),
									url: 'https://medium.com/@jzxhuang'
								}),
								A2(
								mdgriffith$elm_ui$Element$newTabLink,
								...
								{
									label: mdgriffith$elm_ui$Element$text('Resume'),
									url: 'resume/resume_jhuang.pdf'
								})
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text('© 2019 Jeffrey Huang | Made with ♥ and Elm - '),
						A2(
						mdgriffith$elm_ui$Element$newTabLink,
						_List_fromArray(
							[
						...
						{
							label: mdgriffith$elm_ui$Element$text('see source code'),
							url: 'https://github.com/jzxhuang/jzxhuang.github.io'
						})
					]))
			])));
